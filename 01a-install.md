...
>> Python 3. As it is the recommended version.

### Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> Typing python at the command line starts python with the information on python version installed in the computer you are using.
