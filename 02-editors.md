...
>> * An interesting feature of emacs is its ability to open a file by just entering the first few letters of the file and pressing tab to automatically complete the file name.  
